...
<?php include "modal.php"?>
    ...
    <section class="process-section" id="our-process">
        <div class="container agile-sec">
            <div class="col-md-7 wow slideInLeft" style="visibility: visible; animation-name: slideInLeft;">
                ...
                <p style="color:#411855">Designed for remote cooperation’s</p>
            </div>
                ...
                <div role="tabpanel" class="tab-pane active" id="Iterative">
                    <div class="container-fluid row">
                        <div class="col-lg-5 ">
                            ...
                            <p><span style="color:#411855">To improve the quality of a product and optimize costs.</span></p>
                            <p class='text-secondary'>To improve the quality of a product and optimize costs.</p>
                            <p class='text-secondary'><i class="fa fa-check-circle"></i> Flexibility</p>
                            <p class='text-secondary'><i class="fa fa-check-circle"></i> Risk reduction</p>
                            <p class='text-secondary'><i class="fa fa-check-circle"></i> Higher quality</p>
                        </div>
                        <style>
                            /* .col-md-12 {
                                    width: 70%;
      ...
      <div class="next"><span>NEXT</span></div> -->
                    ...
                    <div class="container">
                        <div class='row'>
                            <div class="col-md-12">
                                ...
                                <p class='text-secondary'><span style="color:#33c1bc;">To make technology your competitive advantage.</span></p>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="captions">
                                    ...
                                    <p class='text-secondary' >Scope, milestones, priorities, estimation, reporting</p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="captions">
                                    ...
                                    <p class='text-secondary'>Code Coverage, Quality Gates, Git Flow</p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="captions">
                                    ...
                                    <p class='text-secondary'>Unit, integration, system, and end-to-end testing</p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="captions">
                                    ...
                                    <h4>CI/CD</h4>
                                    <p class='text-secondary'>Executed with Azure DevOps or According to the customer environment</p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="captions">
                                    ...
                                    <h4>Code reviews</h4>
                                    <p class='text-secondary'>Always done by at least two other team members</p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="captions">
                                    ...
                                    <p class='text-secondary'>For the most important parts of business logic</p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="captions">
                                    ...
                                    <h4>Code quality</h4>
                                    <p class='text-secondary'>SOLID, Code Style, Version Control</p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="captions">
                                    ...
                                    <p class='text-secondary'>Scalable servers set up on Azure or AWS or tailored according to the customer needs</p>
                                </div>
                            </div>
                ...
                <div role="tabpanel" class="tab-pane" id="Scalable">
                    <div class="container">
                        <div class="col-md-6">
                            <h4>Scalable</h4>
                            <p><span style="color: #411855;">To speed up quickly whenever you need it.</span></p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="captions" style="margin-top: 10px;">
                                    ...
                                    <p class='text-secondary'>With Vizion Systems Approach, you can easily scale up the team, development velocity and the software itself.</p>
                                </div>
                                <div class="captions">
                                    <img src="img/scc2.svg" class="img-responsive">
                                    <h4>Scaling up your team</h4>
                                    <p class='text-secondary'>You can start small and scale the team along with your business.</p>
                                </div>
                                <div class="captions">
                                    <img src="img/scc2.svg" class="img-responsive">
                                    <h4>Scaling up your team</h4>
                                ...
                                <div class="captions">
                                    ...
                                    <p class='text-secondary'>Our DevOps engineers will help you build secure and scalable infrastructure, so your software is ready to grow with your business.</p>
                                </div>
                            </div>
                ...
                <div role="tabpanel" class="tab-pane" id="Cooperative">
                    <div class=" row">
                        <div class="col-sm-12 col-md-6">
                            <h4>Partnership</h4>
                            <p><span style="color: #f17b3f;">We become part of your team.</span></p>

                            <p class='text-secondary'>Vizion Systems Approach works perfectly when it comes to remote collaboration.</p>

                            <p class='text-secondary'>No matter what, you can't create an amazing software product without close cooperation between the Product Owner and the development team.</p>

                            <p class='text-secondary'>Therefore,&nbsp;we see you as a crucial member of our Agile Team.</p>

                            <p class='text-secondary'>That means you can expect full transparency in the project. As a Product Owner, you are always updated about the status of the development and have full control over the product.</p>

                            <p class='text-secondary'>We invite you to use our tools &amp; channels, development environments and whatever we need to ship the product successfully Together.</p>
                        </div>
                        <div class="col-sm-12 col-md-6">
    ...
    <div id="fluid" class="container-fluid">
        <div class='row '>
            ...
            <div style="margin-bottom:35px;" id="sen" class='col-md-8 col-sm-12 '><img class="thinnk" src="img\cms\website work1.jpg" alt=""></div>
